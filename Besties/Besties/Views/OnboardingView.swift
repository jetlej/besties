...
struct OnboardingView: View {
    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Time Capsule needs Full Disk Access to read your iMessage history.")
                .font(.title3)
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Label("Enable Time Capsule in the list", systemImage: "3.circle.fill")
            }
            .font(.body)
            .padding()
